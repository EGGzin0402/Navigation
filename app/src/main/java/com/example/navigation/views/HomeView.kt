...
import com.example.navigation.componentes.MainButton
import com.example.navigation.componentes.Space
import com.example.navigation.componentes.TitleView
...
fun HomeView(navController: NavController) {
    ...
    Column(
        ...
        Space()
        MainButton(name = "Botões", backColor = Color.Green, color = Color.Black) {
            navController.navigate( "Botoes")
        }
    }
